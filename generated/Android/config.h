...
#define FFMPEG_CONFIGURATION "--target-os=linux --arch=arm --cpu=armv7-a --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-avdevice --disable-encoders --disable-muxers --disable-devices --disable-protocols --disable-avfilter --enable-optimizations --enable-protocol=file --enable-protocol=http --enable-protocol=hls --enable-protocol=mmsh --enable-protocol=mmst --enable-protocol=rtmp --enable-protocol=rtmpe --enable-protocol=rtmps --enable-protocol=rtmpt --enable-protocol=rtmpte --enable-protocol=rtmpts --enable-protocol=rtp --enable-protocol=rtsp --enable-protocol=udp --enable-protocol=applehttp --enable-protocol=https --enable-protocol=tls --disable-avdevice --disable-decoder=dca --disable-demuxer=dts --disable-parser=dca --disable-fast-unaligned --disable-symver --enable-cross-compile --sysroot=/home/heero/dev/perso/android/ndk/platforms/android-8/arch-arm --cc=/home/heero/dev/perso/android/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/home/heero/dev/perso/android/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --extra-cflags='-I/home/heero/dev/perso/android/ndk/platforms/android-8/arch-arm/usr/include -fPIC -DANDROID -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a8 -mvectorize-with-neon-quad' --extra-ldflags='-Wl,--fix-cortex-a8 -L/home/heero/dev/perso/android/ndk/platforms/android-8/arch-arm/usr/lib'"
